...
class NewEventGames extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        ...
        this.setState({ numberOfGames: this.props.defaultNumberOfGames });
    }
    ...
    onEventChange(event) {
        ...
        if(selectedEvent && selectedEvent.useEventGameOptions) {
            ...
            if(selectedEvent.eventGameOptions.numberOfGames !== undefined) {
                this.setState({ numberOfGame: selectedEvent.eventGameOptions.numberOfGames });
            }
    ...
    onSubmitClick(event) {
        ...
        this.props.socket.emit('neweventgames', {
            number: this.state.numberGames,
    ...
    render() {
        ...
        if(this.props.quickJoin) {
            ...
            content = (<div>
                <div className='row'>
                    <div className='col-sm-8'>
                        <label htmlFor='gameNumber'>Num of games</label>
                        <input className='form-control' placeholder='Game Number' type='number' onChange={ this.onNumberChange } />
                    </div>
                </div>
...
NewEventGames.displayName = 'NewEventGames';
NewEventGames.propTypes = {
...
export default connect(mapStateToProps, actions)(NewEventGames);
